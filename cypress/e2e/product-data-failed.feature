...
Funcionalidade: Permissão indevida de navegação com dados inválidos
Cenário:  Navegação permitida com dados inválidos

Dado que acesso o site da Tricentis
E clico na opção Automobile
E preencho os seguintes campos com os dados do automóvel com error:
  | Campo                    | Valor         |
  | Make                     | BMW           |
...
E preencho os seguintes campos com os dados do segurador com error:
  | Campo              | Valor                  |
...
Quando preencho os seguintes campos com os dados do produto:
  | Campo             | Valor                |
  ...
  | Courtesy Car      | Yes                  |
E clico em Next
Então sou direcionada para a Aba Enter Select Price Option